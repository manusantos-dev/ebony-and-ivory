...
const translations = {
  es: {
    ...
    heroSub: "La plataforma definitiva para la notación musical. Transcribe, clasifica y preserva tu repertorio con precisión de grabador.",
    ...
    btnAddNote: "Añadir nota al compás", btnUndoNote: "Deshacer última",
    ...
    minMeasureAlert: "Mínimo un compás.", toggleViewBtn: "Alternar Visor", viewMode: "👁️ Modo Lectura", editMode: "✎ Modo Edición", 
    ...
    footerText: "Ebony & Ivory es un entorno de grabado y archivo musical. Los derechos de las obras transcritas pertenecen a sus respectivos creadores."
  },
  en: {
    ...
    heroSub: "The definitive platform for musical notation. Transcribe, catalog, and preserve your repertoire with engraver-level precision.",
    ...
    btnAddNote: "Add note", btnUndoNote: "Undo last",
    ...
    minMeasureAlert: "Minimum one measure.", toggleViewBtn: "Toggle Viewer", viewMode: "👁️ Read Mode", editMode: "✎ Edit Mode",
    ...
    footerText: "Ebony & Ivory is a music engraving and archiving environment. Copyrights of transcribed works remain with their respective creators."
  }
};
